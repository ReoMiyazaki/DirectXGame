...
void affine::setRotateMat(AffineMat& mat, WorldTransform& worldTransform)
{
	mat.rotX.m[1][1] = cos(worldTransform.rotation_.x);
	mat.rotX.m[1][2] = sin(worldTransform.rotation_.x);
	mat.rotX.m[2][1] = -sin(worldTransform.rotation_.x);
	mat.rotX.m[2][2] = cos(worldTransform.rotation_.x);

	mat.rotY.m[0][0] = cos(worldTransform.rotation_.y);
	mat.rotY.m[0][2] = -sin(worldTransform.rotation_.y);
	mat.rotY.m[2][0] = sin(worldTransform.rotation_.y);
	mat.rotY.m[2][2] = cos(worldTransform.rotation_.y);

	mat.rotZ.m[0][0] = cos(worldTransform.rotation_.z);
	mat.rotZ.m[0][1] = sin(worldTransform.rotation_.z);
	mat.rotZ.m[1][0] = -sin(worldTransform.rotation_.z);
	mat.rotZ.m[1][1] = cos(worldTransform.rotation_.z);
}

Matrix4 affine::generatRotateXMat(WorldTransform& worldTransform)
{
	// X軸回転行列を宣言
	Matrix4 matRotX =
	{
...
Matrix4 affine::generatRotateYMat(WorldTransform& worldTransform)
{
	// Y軸回転行列を宣言
	Matrix4 matRotY =
	{
...
void affine::setTransformMat(Matrix4& mat, WorldTransform& worldTransform)
{
...
Matrix4 affine::generatTransformMat(WorldTransform& worldTransform)
{
	// 平行移動行列を宣言
...
void affine::setTransformationWorldMat(AffineMat& affineMat, WorldTransform& worldTransform)
{
	worldTransform.matWorld_ *= affineMat.scale;
	worldTransform.matWorld_ *= affineMat.rotX;
	worldTransform.matWorld_ *= affineMat.rotY;
	worldTransform.matWorld_ *= affineMat.rotZ;
	worldTransform.matWorld_ *= affineMat.transform;
}